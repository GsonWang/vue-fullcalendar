        ...
        <div class="events-week" v-for="(week, index) in currentDates" :key="index">
          ...
          >
            ...
            <div class="event-box">
              <div
                class="event-item"
                v-for="(event, index3) in day.events"
                :key="index3"
              ...
              >
                ...
                <!-- <p>{{day.date}}</p>  -->
                <slot name="body-card" :event="isBegin(event, day.date, day.weekDay)" :date="day.date" :index="index3"></slot>
                <!-- <slot name="body-card" :event="isBegin(event, day.date, day.weekDay)" :index="index3"></slot> -->
              </div>
              <p
